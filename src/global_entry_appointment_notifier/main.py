...
def get_availability_dates(slots: Iterable[Slot], before_datetime: datetime | None) -> Iterator[datetime]:
    final_slots = slots
    if before_datetime:
...
def process_locations(location_ids: list[str], before_datetime: datetime | None):
    ...
    for location_id in location_ids:
        ...
        available_dates = list(get_availability_dates(available_slots, before_datetime=before_datetime))
